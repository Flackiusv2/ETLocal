"""
Extractor para archivo osb_enf_trans_neumonia.csv
Casos de neumonía con detalle de pacientes
...
class NeumoniaExtractor:
    """Extractor para datos de neumonía"""
    
    def __init__(self, file_path):
        self.file_path = file_path
        self.logger = ETLLogger('NeumoniaExtractor')
        self.df = None
    ...
    def _clean_data(self):
        ...
        # Agregar tipo de enfermedad
        self.df['tipo_enfermedad'] = 'Neumonía'
...
def extract_neumonia(file_path='data_raw/osb_enf_trans_neumonia.csv'):
    """Extrae datos de neumonía"""
    extractor = NeumoniaExtractor(file_path)
    return extractor.extract()

if __name__ == "__main__":
    # Test del extractor
    print("Testing NeumoniaExtractor...")
    df = extract_neumonia()
    print("\n" + "="*60)
    print("RESULTADO:")
    print("="*60)
    ...
    extractor = NeumoniaExtractor('data_raw/osb_enf_trans_neumonia.csv')
    extractor.extract()
